function BoyWalk(){
	...
	function upbridge(){
		$("#boy").css({
			'transform':'translate(-'+bHeight*0.2+'px,'+ -boyHeight*0.44+'px)',
			'transition-delay':'0ms',
			'transition-timing-function':'linear',
			'transition-duration':'2000ms',
			'-webkit-transform':'translate(-'+bHeight*0.2+'px,'+ -boyHeight*0.44+'px)',
			'-webkit-transition-delay':'0ms',
			'-webkit-transition-timing-function':'linear',
			'-webkit-transition-duration':'2000ms',
			'-moz-transform':'translate(-'+bHeight*0.2+'px,'+ -boyHeight*0.44+'px)',
			'-moz-transition-delay':'0ms',
			'-moz-transition-timing-function':'linear',
			'-moz-transition-duration':'2000ms',
			'-ms-transform':'translate(-'+bHeight*0.2+'px,'+ -boyHeight*0.44+'px)',
			'-ms-transition-delay':'0ms',
			'-ms-transition-timing-function':'linear',
			'-ms-transition-duration':'2000ms',
			'-o-transform':'translate(-'+bHeight*0.2+'px,'+ -boyHeight*0.44+'px)',
	...
	function turn(){
		...
		$("#boy img").css({
			'transform':'translate(-'+boyHeight*1+'px,0)',
			'-webkit-transform':'translate(-'+boyHeight*1+'px,0)',
			'-moz-transform':'translate(-'+boyHeight*1+'px,0)',
			'-ms-transform':'translate(-'+boyHeight*1+'px,0)',
			'-o-transform':'translate(-'+boyHeight*1+'px,0)',
			// left:boyHeight* -3+"px",
